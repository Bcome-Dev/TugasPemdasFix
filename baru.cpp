...
void displayAllMahasiswa() {
    ...
    cout << "--------------------------------------------" << endl;
    for (int i = 0; i < mahasiswaCount; i++) {
        cout << (i + 1) << "    " << mahasiswaList[i].nama;
        for (size_t j = mahasiswaList[i].nama.length(); j < 20; j++) cout << " ";
        cout << mahasiswaList[i].saldo << endl;
    }
    cout << "============================================" << endl;
}
...
void displayRekapPenarikan() {
    ...
    cout << "============================================" << endl;
    cout << "No   Nama                 Jumlah    Keterangan          Waktu" << endl;
    cout << "--------------------------------------------------------------------------" << endl;
    for (int i = 0; i < penarikanCount; i++) {
        cout << (i + 1) << "    " << penarikanList[i].nama;
        for (size_t j = penarikanList[i].nama.length(); j < 20; j++) cout << " ";
        cout << penarikanList[i].jumlah;
        for (size_t j = to_string((int)penarikanList[i].jumlah).length(); j < 10; j++) cout << " ";
        cout << penarikanList[i].keterangan;
        for (size_t j = penarikanList[i].keterangan.length(); j < 20; j++) cout << " ";
        cout << penarikanList[i].waktu << endl;
    }
    cout << "============================================" << endl;
}
